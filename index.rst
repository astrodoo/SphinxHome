...
been studying theoretically the effects of Active Galactic Nuclei Feedback on the evolution of isolated Early Type Galaxies
considering the galactic rotation and its angular momentum transport outward. Please stay tunned on the progress
of this project. It should be interesting.

I graduated at the `University of Wisconsin-Madison`_, supervised by `Prof. Sebastian Heinz`_.
...
.. _Prof. Feng Yuan and his group members: http://center.shao.ac.cn/fyuan
.. _Shanghai Astronomical Observatory: http://english.shao.cas.cn/
.. _University of Wisconsin-Madison: http://www.astro.wisc.edu/
.. _Prof. Sebastian Heinz: http://www.astro.wisc.edu/~heinzs
...
.. topic:: News
   ...
   * present a poster in `AAS 225th <http://aas.org/meetings/aas225>`_ at Seattle, WA (Jan.04-08,2015)
